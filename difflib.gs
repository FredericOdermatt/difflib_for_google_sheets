...
var Differ, IS_CHARACTER_JUNK, IS_LINE_JUNK, SequenceMatcher, assert, contextDiff, floor, getCloseMatches, max, min, ndiff, restore, unifiedDiff, _any, _arrayCmp, _calculateRatio, _countLeading, _formatRangeContext, _formatRangeUnified, _has,
...
this._countLeading = _countLeading;

this.Differ = Differ;

this.IS_LINE_JUNK = IS_LINE_JUNK;

this.IS_CHARACTER_JUNK = IS_CHARACTER_JUNK;

this._formatRangeUnified = _formatRangeUnified;

this.unifiedDiff = unifiedDiff;

this._formatRangeContext = _formatRangeContext;
...
class Heap {
  ...
  bubbleDown(index) {
    ...
    while (true) {
      ...
      if (leftIndex < length) {
        if (this.compare(this.data[leftIndex], value) < 0) {
          swapIndex = leftIndex;
        }
      }
      ...
      if (rightIndex < length) {
        if (
          this.compare(this.data[rightIndex], value) < 0 &&
          (swapIndex === null || this.compare(this.data[rightIndex], this.data[swapIndex]) < 0)
        ) {
